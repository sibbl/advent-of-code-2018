...
const returnWordIfOnlyOneCharacterDifferent = (str1, str2) => {
    for(let i = 0; i < str1.length; i++) {
        const str1WithoutSingleChar = str1.substring(0, i) + str1.substring(i + 1, str1.length);
        const str2WithoutSingleChar = str2.substring(0, i) + str2.substring(i + 1, str2.length);
